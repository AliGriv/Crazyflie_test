...
class Trajectory_Planner:
        ...
        setPointCoordinates = [[0,0,0,0], [0,0,1.5,2], [0,0,1.5,45] , [0,0,0,3]] # The sequence of coordinates for the leader copter to get to at a certain time, [x,y,z, Time] all in the world frame!
